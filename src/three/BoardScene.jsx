    ...
    >
      ...
      {REGION_LIST.map((r) => (
        <RegionTile
          ...
          creatureSlot={r.id === 'blackspire' && bossSpawned && bossHp > 0 ? { defId: 'vhalrax', hp: bossHp, provoked: bossProvoked } : creatures[r.id]}
          onClick={() => {
      ...
      {bossSpawned && bossHp > 0 && (
        <Suspense fallback={null}>
          <CreatureToken regionId="blackspire" slot={{ defId: 'vhalrax', hp: bossHp, provoked: bossProvoked }} boss reducedMotion={reducedMotion} />
        </Suspense>
      )}
