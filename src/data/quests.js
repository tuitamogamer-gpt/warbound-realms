...
export const QUESTS = [
  ...
  {
    id: 'bristle_and_thorn',
    name: 'Bristle and Thorn',
    type: 'killCreature',
    creature: 'thistle_boar',
    text: 'Slay a Thistle Boar.',
    reward: { xp: 2, gold: 2, vp: 1 },
  },
  {
    id: 'the_broken_bargain',
  ...
  {
    id: 'grounded_thunder',
    name: 'Grounded Thunder',
    type: 'killCreature',
    creature: 'storm_roc',
    text: 'Slay the Storm Roc.',
